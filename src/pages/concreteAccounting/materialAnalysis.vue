...
export default {
  ...
  methods: {
    onChange (val) {
       this.detail=[]
    let array=[
          {name:'石子',quantity:'377.8',receiveQuantity:'43',jcblStr:'0',jc:''},
          {name:'中粗-2',quantity:'42',receiveQuantity:'46',jcblStr:'0',jc:''},
          {name:'水泥',quantity:'319',receiveQuantity:'226',jcblStr:'0',jc:''},
          {name:'砂子',quantity:'295.5',receiveQuantity:'249',jcblStr:'0',jc:''},
      ]
   ...
   _clickName(){
    ...
    _fetchData() {
      var that = this;
       that.detail=[]
      let array=[
          {name:'水泥',quantity:'348.5',receiveQuantity:'310',jcblStr:'0',jc:''},
          {name:'石子',quantity:'290',receiveQuantity:'245',jcblStr:'0',jc:''},
          {name:'砂子',quantity:'389.5',receiveQuantity:'385',jcblStr:'0',jc:''},
          {name:'中粗-2',quantity:'468',receiveQuantity:'459',jcblStr:'0',jc:''},
      ]
      for (let index = 0; index < array.length; index++) {
            let element = array[index];
            element.jc=element.quantity-element.receiveQuantity
