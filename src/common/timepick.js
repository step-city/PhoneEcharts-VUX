export default {
    ...
    getCurrentWeek:function(){    
        ...
        var mondayd=this.changeTime(monday);
        //本周 周日    
        var sunday=new Date(monday.getTime()+(6*millisecond));   
        var sundayd=this.changeTime(sunday);
        //添加本周时间    
    ...
    getCurrentMonth:function(){    
        ...
        var firstDayd=this.changeTime(firstDay);
        ...
        var lastDayd=this.changeTime(lastDay);
    ...
    getCurrentSeason:function(){    
        ...
        var quarterSeasonStartDated=this.changeTime(quarterSeasonStartDate);
           
        //获得本季度结束的日期    
        var quarterSeasonEndDate=new Date(currentYear,quarterSeasonEndMonth,this.getMonthDays(currentYear, quarterSeasonEndMonth));    
        var quarterSeasonEndDated=this.changeTime(quarterSeasonEndDate);
